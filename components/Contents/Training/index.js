...
const courseList = [
  {
    key: "training-1",
    time: "Aug 2023",
    name: "Agile & Scrum, Design Thinking, and Professional public speaking and presentations",
    organize: "Office of the Civil Service Commission, OCSC",
  },
  {
    key: "training-2",
    time: "May 2023",
    name: "Secure Coding",
    organize: "IRobust Co., Ltd.",
  },
  {
    key: "training-3",
    time: "May 2022",
...
const Training = () => {
  ...
  const scrollHandler = ({ target: { scrollLeft } }) => {
  ...
  return (
    <TopicLayout id="training" title="Training">
      <ol
        ...
        className="relative flex overflow-x-scroll items-start p-4 bg-medium-blue/20 rounded-md px-4 sm:px-8 shadow-md"
      >
        {!scroll && (
          <div className="absolute right-8 bottom-[10%] -rotate-90">
            <svg
          ...
          return (
            <li key={el.key} className="relative mb-6 pl-1">
              ...
              <div className="mt-4 pr-8 w-full">
                <div className="block text-sm leading-none text-white/40 mb-0.5">
                  {el.time}
                </div>
                <div className="text-lg mb-2 font-bold text-white">
                  {el.name}
                </div>
